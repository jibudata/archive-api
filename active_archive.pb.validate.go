...
// Validate checks the field values on RecallSearchedFilesResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RecallSearchedFilesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RecallSearchedFilesResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RecallSearchedFilesResponseMultiError, or nil if none found.
func (m *RecallSearchedFilesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *RecallSearchedFilesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RecallSearchedFilesResponseMultiError(errors)
	}

	return nil
}

// RecallSearchedFilesResponseMultiError is an error wrapping multiple
// validation errors returned by RecallSearchedFilesResponse.ValidateAll() if
// the designated constraints aren't met.
type RecallSearchedFilesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RecallSearchedFilesResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RecallSearchedFilesResponseMultiError) AllErrors() []error { return m }

// RecallSearchedFilesResponseValidationError is the validation error returned
// by RecallSearchedFilesResponse.Validate if the designated constraints
// aren't met.
type RecallSearchedFilesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RecallSearchedFilesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RecallSearchedFilesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RecallSearchedFilesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RecallSearchedFilesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RecallSearchedFilesResponseValidationError) ErrorName() string {
	return "RecallSearchedFilesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e RecallSearchedFilesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRecallSearchedFilesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RecallSearchedFilesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RecallSearchedFilesResponseValidationError{}
